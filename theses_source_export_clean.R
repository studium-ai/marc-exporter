...
theses_sources %>% 
  write_csv(paste0('thesis_export/', Sys.Date(),'_the_sources_table.csv'))

theses_links %>% 
  write_csv(paste0('thesis_export/',Sys.Date(),'_the_sources_links_table.csv'))

theses_links_mms %>% 
  write_csv(paste0('thesis_export/',Sys.Date(),'_the_sources_links_mms_table.csv'))
...
theses_inst %>% 
  write_csv(paste0('thesis_export/',Sys.Date(),'_the_sources_institutions_table.csv'))
